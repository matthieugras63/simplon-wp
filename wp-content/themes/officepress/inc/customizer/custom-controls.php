 ...
 */
class OfficePress_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class OfficePress_Dropdown_Category_Control extends WP_Customize_Control {
...
class OfficePress_Note_Control extends WP_Customize_Control {
...
class OfficePress_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class OfficePress_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="officepress-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 */
class OfficePress_Custom_Radio_Image_Control extends WP_Customize_Control {
...
class OfficePress_Icon_Picker extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <input id="officepress-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'officepress' ); ?>" class="officepress-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
            </label>
		<?php
	}
}
...
Class OfficePress_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
 ...
 * @since  1.0.0
 */
class OfficePress_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
