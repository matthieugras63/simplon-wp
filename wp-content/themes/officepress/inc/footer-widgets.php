...
class OfficePress_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'officepress';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'officepress' ), $i ),
...
// Initialize.
$officepress_footer_widgets = new OfficePress_Footer_Widgets();
